...
/// Re-binds every open LOCAL project after the host comes back from a death we
/// did not ask for. The respawned host has none of the old cores open and the
/// loopback sockets died with the process, so without this the supervised
/// restart would bring the bridge back under a workspace still wired to dead
/// transports.
///
