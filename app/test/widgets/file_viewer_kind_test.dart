...
void main() {
  group('fileViewerKindFor', () {
    test('markdown by extension', () {
      expect(fileViewerKindFor('docs/readme.md', null), FileViewerKind.markdown);
    ...
    test('image from base64 mimeType', () {
      expect(fileViewerKindFor('a.png', 'base64', 'image/png'),
          FileViewerKind.image);
      // Bytes not present yet (still text-encoded) → code, not image.
      expect(fileViewerKindFor('a.png', 'utf8', 'image/png'),
          FileViewerKind.code);
    ...
    test('pdf from base64 mimeType', () {
      expect(fileViewerKindFor('a.pdf', 'base64', 'application/pdf'),
          FileViewerKind.pdf);
      expect(fileViewerKindFor('a.pdf', 'utf8', 'application/pdf'),
          FileViewerKind.code);
    });
