...
void main() {
  test('RecentAgent round-trips hostMachineName; tolerates missing field', () {
    final a = RecentAgent(
      agentDeviceId: 'd', agentLabel: 'l', agentEd25519Pubkey: 'k',
      relayUrl: 'wss://r', phoneDeviceId: 'p', phoneEd25519Pubkey: 'pk',
      pairedAt: DateTime(2026), lastConnectedAt: DateTime(2026),
      hostMachineName: 'Mac Studio',
    );
    final back = RecentAgent.fromJson(a.toJson());
    expect(back.hostMachineName, 'Mac Studio');

    final legacy = Map<String, dynamic>.from(a.toJson())..remove('hostMachineName');
