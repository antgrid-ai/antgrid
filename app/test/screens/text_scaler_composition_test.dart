...
void main() {
  testWidgets(
    'composes uiScale with the OS scaler',
    (tester) async {
  ...
  testWidgets(
    'clamps the composed product to the 2.0 ceiling',
    (tester) async {
  ...
  testWidgets(
    'clamps the composed product to the 0.85 floor',
    (tester) async {
  ...
  testWidgets(
    'replaces the OS scaler outright with uiScale',
    (tester) async {
      await tester.pumpWidget(_harness(uiScale: 1.15));
