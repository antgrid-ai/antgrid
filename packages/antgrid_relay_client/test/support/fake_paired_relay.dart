...
//
// A fake RelayService that starts already `paired` (so MachineSession.start()
// immediately drives the handshake) and records every outbound sendMessage
// call, plus an instant [SessionHandshaker] that resolves to fixed
...
class FakePairedRelay extends RelayService {
  FakePairedRelay({RelayConnectionState initial = RelayConnectionState.paired})
