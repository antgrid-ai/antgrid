...
void main() {
  ...
  group('GhosttyTerminalResolvedStyle', () {
      ...
      () {
        final resolved = GhosttyTerminalResolvedStyle.fromFormattedStyle(
          style: const GhosttyTerminalStyle(
            foreground: GhosttyTerminalColor.palette(9),
            background: GhosttyTerminalColor.palette(11),
            underlineColor: GhosttyTerminalColor.palette(12),
            bold: true,
            italic: true,
            faint: false,
            blink: false,
    ...
    test('applies inverse swapping with explicit vs implicit style colors', () {
      final explicit = GhosttyTerminalResolvedStyle.fromFormattedStyle(
        style: const GhosttyTerminalStyle(
      ...
      final implicit = GhosttyTerminalResolvedStyle.fromFormattedStyle(
        style: const GhosttyTerminalStyle(
          bold: false,
          italic: false,
          faint: false,
    ...
    test('supports invisible and faint transforms consistently', () {
      final faint = GhosttyTerminalResolvedStyle.fromFormattedStyle(
        style: const GhosttyTerminalStyle(
          foreground: GhosttyTerminalColor.rgb(255, 120, 40),
          bold: false,
          italic: false,
          faint: true,
          blink: false,
      ...
      final invisible = GhosttyTerminalResolvedStyle.fromFormattedStyle(
        style: const GhosttyTerminalStyle(
          foreground: GhosttyTerminalColor.palette(1),
          bold: false,
          italic: false,
    ...
    test(
      ...
      () {
        final style = GhosttyTerminalResolvedStyle.fromFormattedStyle(
          style: const GhosttyTerminalStyle(
            bold: false,
            italic: false,
            faint: false,
    ...
    test('falls back when palette index is out of palette range', () {
      final resolved = GhosttyTerminalResolvedStyle.fromFormattedStyle(
        style: const GhosttyTerminalStyle(
          foreground: GhosttyTerminalColor.palette(255),
          background: GhosttyTerminalColor.palette(300),
          underlineColor: GhosttyTerminalColor.palette(300),
          bold: false,
          italic: false,
          faint: false,
          blink: false,
