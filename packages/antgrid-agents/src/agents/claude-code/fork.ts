...
export function claudeLegacyForkSource(args: readonly string[]): string | undefined {
  return args.length === 3 && !!args[1] && args[0] === "--resume" && args[2] === "--fork-session" ? args[1] : undefined;
}
