 ...
 *  hook command. */
export function antigravityScriptPath(directory: string): string {
  return spaceSafePath(bundledPluginPath(directory, "antigravity", "post-title.js"));
}
 ...
 * under ANTIGRAVITY_HOOK_GROUP (replacing managed events — any other groups/hooks already in
